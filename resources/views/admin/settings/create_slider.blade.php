...
@section('content')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@lang('main.slider.create_slider')</li>
    </ol>
    <div class="card mb-3">
        <div class="card-header">
            <div>
                ...
                @lang('main.slider.create_slider')
            </div>
            ...
            <div class="table-responsive">
                <form action="{{route('slider.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input name="title[ru]" type="text" class="form-control">
                        <span class="text-danger">{{$errors->first('title.ru')}}</span>
                    </div>
                    <div class="form-group">
                        <label for="name">@lang('main.global.title') Ua</label>
                        <input name="title[ua]" type="text" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <input  name="order" id="numeric_input" type="number" value="{{$last_order}}" class="form-control">
                        <span class="text-danger">{{$errors->first('order')}}</span>
                    </div>
                    <div class="form-group">
                        <div class="text-center">
                            <button class="btn btn-dark" type="submit">@lang('main.slider.create_slider')</button>
                        </div>
                    </div>
                </form>
            </div>
