...
@section('content')
    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            <form action="{{route('statistics.update',$mod)}}" method="POST" id="left_banner_form"
                ...
                <table class="table table-hover table-statements table-bordered text-center">
                    ...
                    <tr>
                        <td><label class="form-label">@lang('main.elements.sum')</label></td>
                        <td colspan="3"><input type="text" name="sum" class="form-control"
                                   value="{{$fields['en']->sum}}"></td>
