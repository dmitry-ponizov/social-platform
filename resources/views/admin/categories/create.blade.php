...
@section('content')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">@lang('main.category.create')</li>
    </ol>
    <div class="card mb-3">
        <div class="card-header">
            @lang('main.category.create')
        </div>
        <div class="card-body">
                ...
                <form action="{{route('category.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <div class="text-center">
                            <button class="btn btn-dark" type="submit">@lang('main.category.create')</button>
                        </div>
                    </div>
                </form>
            </div>
