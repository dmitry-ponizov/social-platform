                        ...
                        <div class="edit_container ">
                            ...
                            <div class="info_block">
                                <date-picker @change="changeDate"
                                             :time-picker-options="{start: '00:00',end: '23:30'}" v-model="time" range
                                             :lang="language" format="dd-MM-yyyy" confirm></date-picker>
                            </div>
                        </div>
                        <div v-for="(statistic,index) in statistics">
                            <statistic-field :statistic="statistic" :title="index"></statistic-field>
                        </div>
                    </div>
                </div>
            </slot>
...
<script>
    ...
    import StatisticField from '../organization/StatisticField.vue';
    ...
    export default {
        ...
        data() {
            return {
                ...
                statistics: '',
                language: 'ru',
                url: '/activity/social-service-statistics',
            }
        },
        mounted() {
