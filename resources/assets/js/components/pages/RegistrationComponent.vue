    ...
    <div id="static_reg">
        <div class="content">
            <div class="ui centered grid">
                <div class="sixteen wide column ui form register-form">
                    ...
                    <slot v-if="viewOrg">
                        <div class="org_fields">
                            <reg-org-component :method="changeField"
                    ...
                    <div class="field register-field">
                        <button type="submit" id="register_static" @click="onSubmit" class="ui button">
