...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            statements() {
                let statements = this.$store.getters.getStatementsClosedList;
        ...
        methods: {
            getData(url) {
                ...
                axios.get(url).then(response => {
                    if (response.data !== 'error') {
                        ...
                        this.$store.commit('add_statement_closed_list', response.data);
                    }
                }).catch(error => {
            ...
            makePagination(data) {
                ...
                this.$store.commit('add_statement_closed_pages', pagination);

            },
            singlePagination(data) {
                let pages = this.$store.getters.getStatementsClosedPages;
                if (!pages[data]) {
                    let url = '/statements/closed?page=';
                    url += data;
                    this.getData(url);
                } else {
